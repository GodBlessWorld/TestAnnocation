 ...
 * @generated
 */
public class ArcadeTongame_editorDiagramEditorUtil {
	...
	public static boolean openDiagram(Resource diagram)
		...
		page.openEditor(
				...
				ArcadeTongame_editor.diagram.part.ArcadeTongame_editorDiagramEditor.ID);
		return true;
	}
	...
	public static Resource openModel(Shell shell, String description,
		...
		try {
			...
			MessageDialog
					.openError(
							shell,
							ArcadeTongame_editor.diagram.part.Messages.ArcadeTongame_editorDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
							NLS.bind(
									ArcadeTongame_editor.diagram.part.Messages.ArcadeTongame_editorDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
									fileName));
		}
		return resource;
	}
	...
	public static void runWizard(Shell shell, Wizard wizard, String settingsKey) {
		IDialogSettings pluginDialogSettings = ArcadeTongame_editor.diagram.part.ArcadeTongame_editorDiagramEditorPlugin
	...
	public static Resource createDiagram(URI diagramURI, URI modelURI,
		...
		progressMonitor
				.beginTask(
						ArcadeTongame_editor.diagram.part.Messages.ArcadeTongame_editorDiagramEditorUtil_CreateDiagramProgressTask,
						3);
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
				editingDomain,
				ArcadeTongame_editor.diagram.part.Messages.ArcadeTongame_editorDiagramEditorUtil_CreateDiagramCommandLabel,
				Collections.EMPTY_LIST) {
			protected CommandResult doExecuteWithResult(
					IProgressMonitor monitor, IAdaptable info)
					throws ExecutionException {
				ArcadeTongame_editor.Game model = createInitialModel();
	 ...
	 * @generated
	 */
	private static ArcadeTongame_editor.Game createInitialModel() {
		return ArcadeTongame_editor.ArcadeTongame_editorFactory.eINSTANCE
				.createGame();
	}
	 ...
	 * @generated
	 */
	private static void attachModelToResource(ArcadeTongame_editor.Game model,
			Resource resource) {
