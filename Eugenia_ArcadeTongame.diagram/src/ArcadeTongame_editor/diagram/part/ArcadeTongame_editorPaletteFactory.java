...
public class ArcadeTongame_editorPaletteFactory {
	...
	private ToolEntry createIn1CreationTool() {
		...
		entry.setSmallIcon(ArcadeTongame_editor.diagram.part.ArcadeTongame_editorDiagramEditorPlugin
				.findImageDescriptor("/Eugenia_ArcadeTongame/icons/In32.ico")); //$NON-NLS-1$
	...
	private ToolEntry createOut2CreationTool() {
		...
		entry.setSmallIcon(ArcadeTongame_editor.diagram.part.ArcadeTongame_editorDiagramEditorPlugin
				.findImageDescriptor("/Eugenia_ArcadeTongame/icons/Out32.ico")); //$NON-NLS-1$
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createStage4CreationTool() {
		...
		entry.setSmallIcon(ArcadeTongame_editor.diagram.part.ArcadeTongame_editorDiagramEditorPlugin
				.findImageDescriptor("/Eugenia_ArcadeTongame/icons/Stage32.ico")); //$NON-NLS-1$
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createText5CreationTool() {
		...
		entry.setSmallIcon(ArcadeTongame_editor.diagram.part.ArcadeTongame_editorDiagramEditorPlugin
				.findImageDescriptor("/Eugenia_ArcadeTongame/icons/Text32.ico")); //$NON-NLS-1$
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createWall6CreationTool() {
		...
		entry.setSmallIcon(ArcadeTongame_editor.diagram.part.ArcadeTongame_editorDiagramEditorPlugin
				.findImageDescriptor("/Eugenia_ArcadeTongame/icons/Wall32.ico")); //$NON-NLS-1$
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createStagesConnection2CreationTool() {
		...
		entry.setSmallIcon(ArcadeTongame_editor.diagram.part.ArcadeTongame_editorDiagramEditorPlugin
				.findImageDescriptor("/Eugenia_ArcadeTongame/icons/StagesConnection32.ico")); //$NON-NLS-1$
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
