package ArcadeTongame_editor.diagram.application;
...
public class DiagramEditorActionBarAdvisor extends ActionBarAdvisor {
	...
	protected void fillMenuBar(IMenuManager menu) {

		{
			IMenuManager menuX = new MenuManager(
					ArcadeTongame_editor.diagram.part.Messages.ApplicationMenuName_File,
...

			{
				IMenuManager menuXX = new MenuManager(
						ArcadeTongame_editor.diagram.part.Messages.ApplicationMenuName_New,
						"new");
		...
		{
			IMenuManager menuX = new MenuManager(
					ArcadeTongame_editor.diagram.part.Messages.ApplicationMenuName_Edit,
		...
		{
			IMenuManager menuX = new MenuManager(
					ArcadeTongame_editor.diagram.part.Messages.ApplicationMenuName_Window,
		...
		{
			IMenuManager menuX = new MenuManager(
					ArcadeTongame_editor.diagram.part.Messages.ApplicationMenuName_Help,
		...
		if (editorDescriptor == null) {
			MessageDialog
					.openError(
							...
							ArcadeTongame_editor.diagram.part.Messages.DiagramEditorActionBarAdvisor_DefaultFileEditorTitle,
							NLS.bind(
									ArcadeTongame_editor.diagram.part.Messages.DiagramEditorActionBarAdvisor_DefaultFileEditorMessage,
			...
			try {
				...
				MessageDialog
						.openError(
								workbenchWindow.getShell(),
								ArcadeTongame_editor.diagram.part.Messages.DiagramEditorActionBarAdvisor_DefaultEditorOpenErrorTitle,
	...
	public static class NewDiagramAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			ArcadeTongame_editor.diagram.part.ArcadeTongame_editorCreationWizard wizard = new ArcadeTongame_editor.diagram.part.ArcadeTongame_editorCreationWizard();
	...
	public static class AboutAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			MessageDialog
					.openInformation(
							getWindow().getShell(),
							ArcadeTongame_editor.diagram.part.Messages.DiagramEditorActionBarAdvisor_AboutDialogTitle,
							ArcadeTongame_editor.diagram.part.Messages.DiagramEditorActionBarAdvisor_AboutDialogMessage);
		}
	}
