...
/**
 * This is the item provider adapter for a {@link ArcadeTongame_editor.Out} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OutItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Out_isOpen_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Out_isOpen_feature", "_UI_Out_type"),
				 ArcadeTongame_editorPackage.Literals.OUT__IS_OPEN,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Out)object).getName();
